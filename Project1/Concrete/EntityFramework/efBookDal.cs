...
namespace Project1.Concrete.EntityFramework
{
    public class efBookDal : IBookDal
    {
        ...
        {
            var nbook = _booklist.FirstOrDefault(w => w.IsValid == true && w.Isbn == book.Isbn);
            if (nbook != null)
            {
                nbook.Quantity_Left++;
                return true;
            ...
            {
                throw new Exception("Book is not valid,so is not book to stock");                
            }
        }
        ...
        private void CreateFaker(int count)
        {
            ...
            var bookfaker = new Faker<Book>()
                ...
                .RuleFor(i => i.Autor, autorfaker)
                .RuleFor(i => i.Publisher, publisherfaker)
